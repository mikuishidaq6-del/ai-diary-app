...
//                   children: [
//                     _buildTextField(
//                         _temperatureController, "体温 (℃)", Icons.thermostat),
//                     _buildTextField(
//                         _bloodPressureController, "血圧 (mmHg)", Icons.favorite),
//                     _buildTextField(
//                         _pulseController, "脈拍 (/分)", Icons.monitor_heart),
//                     _buildTextField(
//                         _spo2Controller, "SpO₂ (%)", Icons.bloodtype),
//                     _buildTextField(
//                         _weightController, "体重 (kg)", Icons.monitor_weight),
//                     _buildTextField(
//                         _wbcController, "白血球数 (/µL)", Icons.biotech),
//                     _buildTextField(
//                         _rbcController, "赤血球数 (/µL)", Icons.bloodtype_outlined),
//                     _buildTextField(
//                         _plateletsController, "血小板数 (/µL)", Icons.opacity),
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       backgroundColor: Colors.pink[50], // 背景も桜色
//       body: Column(
//         children: [
//           const SizedBox(height: 12),
//           Row(
//             mainAxisAlignment: MainAxisAlignment.center,
//             children: const [
//               Icon(Icons.menu_book, color: Colors.pinkAccent, size: 28),
//               SizedBox(width: 8),
//               Text(
//                 "タイムライン",
//                 style: TextStyle(
...
//             child: ValueListenableBuilder(
//               valueListenable:
//               Hive.box<HealthRecord>('records').listenable(),
//               builder: (context, Box<HealthRecord> box, _) {
//                 if (box.isEmpty) {
//                   return const Center(
